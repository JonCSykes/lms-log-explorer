 ...
 */
export function extractJsonBlock(message: string): { json?: object; raw: string; error?: boolean } {
...
export function createJsonAccumulator(): JsonAccumulator {
  ...
  function accumulate(line: string): { done: boolean; json?: object; raw: string } {
    buffer += line + '\n';
